...
angular.module('SimpleRESTIonic', ['ionic', 'backand', 'SimpleRESTIonic.controllers', 'SimpleRESTIonic.services','chart.js'])
    ...
    .config(function (BackandProvider, $stateProvider, $urlRouterProvider, $httpProvider,$ionicConfigProvider) {
        ...
        BackandProvider.setAnonymousToken('f4930452-3eb9-48bb-89fd-2d90e9058539'); // token is for anonymous login. see http://docs.backand.com/en/latest/apidocs/security/index.html#anonymous-access
